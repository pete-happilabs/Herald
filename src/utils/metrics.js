...
const circuitBreakerOpen = new client.Counter({
  name: 'herald_circuit_breaker_open_total',
...
// Pipeline health
const pipelineHealth = new client.Gauge({
  name: 'herald_pipeline_health',
  help: 'Pipeline health status (0=down, 1=up)',
  labelNames: ['channel', 'provider'],
  registers: [register]
});

// SMS balance
const smsBalance = new client.Gauge({
  name: 'herald_sms_balance',
  help: 'SMS provider credit balance',
  labelNames: ['provider'],
  registers: [register]
});
